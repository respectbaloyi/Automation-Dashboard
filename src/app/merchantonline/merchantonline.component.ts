...
@Component({
  selector: 'app-merchantonline',
  templateUrl: './merchantonline.component.html',
  styleUrls: ['./merchantonline.component.css']
})
export class MerchantonlineComponent implements OnInit, AfterViewInit {

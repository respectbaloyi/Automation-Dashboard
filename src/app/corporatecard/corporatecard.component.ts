...
@Component({
  selector: 'app-corporatecard',
  templateUrl: './corporatecard.component.html',
  styleUrls: ['./corporatecard.component.css']
})
export class CorporatecardComponent implements OnInit, AfterViewInit {
